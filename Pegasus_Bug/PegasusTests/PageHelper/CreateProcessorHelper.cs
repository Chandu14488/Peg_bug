...
{
    public class CreateProcessorHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateProcessorHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateProcessor.xml");
        }
...
// ###########################  XML  ##############
        ...
        {
            GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selenium_corp/masterdata/processor_types");
        }
        ...
        public void redirectToPayout()
        {
            GetWebDriver()
                .Navigate()
                .GoToUrl("https://www.pegasus-test.com/selenium_corp/selenium_office/processor_types");
        }
