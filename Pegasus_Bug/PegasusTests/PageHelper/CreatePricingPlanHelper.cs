...
{
    public class CreatePricingPlanHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreatePricingPlanHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreatePricingPlan.xml");
        }
...
// ###########################  XML  ##############
        ...
        {
            GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selenium_corp/masterdata/pricing_plans");
        }
        ...
        public void redirectToAdminAmex()
        {
            GetWebDriver()
                .Navigate()
                .GoToUrl("https://www.pegasus-test.com/selenium_corp/selenium_office/pricing_plans");
        }
