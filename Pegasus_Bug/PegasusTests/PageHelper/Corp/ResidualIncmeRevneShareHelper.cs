...
{
    public class ResidualIncmeRevneShareHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResidualIncmeRevneShareHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeRevenueShareCorp.xml");
        }
...
// ###########################  XML  ##############
        ...
        {
            GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selenium_corp/rir/master_revenue/create");
        }
