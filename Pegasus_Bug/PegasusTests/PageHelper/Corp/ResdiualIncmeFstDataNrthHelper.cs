...
{
    public class ResdiualIncmeFstDataNrthHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResdiualIncmeFstDataNrthHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeImportFirstData.xml");
        }
