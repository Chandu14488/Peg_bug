...
{
    public class ResdiualIncmeWorldPayHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResdiualIncmeWorldPayHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeWorldPay.xml");
        }
