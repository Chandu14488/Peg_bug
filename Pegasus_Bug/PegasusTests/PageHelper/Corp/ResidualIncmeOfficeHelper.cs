...
{
    public class ResidualIncmeOfficeHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResidualIncmeOfficeHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeOffice.xml");
        }
