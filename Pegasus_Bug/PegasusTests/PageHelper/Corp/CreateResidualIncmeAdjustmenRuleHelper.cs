...
{
    public class CreateResidualIncmeAdjustmenRuleHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateResidualIncmeAdjustmenRuleHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateResidualIncomeAdjustmentRuleCorp.xml");
        }
