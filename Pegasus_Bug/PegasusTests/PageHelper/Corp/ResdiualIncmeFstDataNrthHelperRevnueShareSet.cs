...
{
    public class ResdiualIncmeFstDataNrthHelperRevnueShareSet : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResdiualIncmeFstDataNrthHelperRevnueShareSet(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeImprtFirstDataRevenueShare.xml");
        }
