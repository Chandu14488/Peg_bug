...
{
    public class ImportAndCalculationRIHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ImportAndCalculationRIHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ImportAndCalculationRI.xml");
        }
