...
{
    public class ResdiualIncmeSkipHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResdiualIncmeSkipHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResidualIncomeImportSkip.xml");
        }
