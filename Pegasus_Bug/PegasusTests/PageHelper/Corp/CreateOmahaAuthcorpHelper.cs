...
{
    public class CreateOmahaAuthcorpHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateOmahaAuthcorpHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateOmahaAuthGrip.xml");
        }
