...
{
    public class CreateAmexRateHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateAmexRateHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateAmexRate.xml");
        }
...
// ###########################  XML  ##############
        ...
        {
            GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selenium_corp/masterdata/amex_rates");
        }
