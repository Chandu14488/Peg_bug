...
{
    public class EditEmployeeAgentHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public EditEmployeeAgentHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("EditEmployeeAgent.xml");
        }
