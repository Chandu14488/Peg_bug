...
{
    public class CreateOmahaAuthGripHelperNewSkin : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateOmahaAuthGripHelperNewSkin(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("MasterDataNewSkin.xml");
        }
