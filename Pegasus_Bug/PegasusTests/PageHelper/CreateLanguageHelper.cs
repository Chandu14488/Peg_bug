...
{
    public class CreateLanguageHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateLanguageHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateLanguage.xml");
        }
        ...
        */
        ...
        public void elementLod(string field)
        {
            ...
            WaitForElementEnabled(locator, 50);
                ...
                //Select by text
        public void SelectText(string Field, string Text)
    {
        var locator = locatorReader.ReadLocator(Field);
