...
{
    public class CreatePrcingPlanHelperAdmin : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreatePrcingPlanHelperAdmin(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreatePricingPlanAdmin.xml");
        }
