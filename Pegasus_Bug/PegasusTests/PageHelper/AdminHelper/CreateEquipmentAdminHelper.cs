...
{
    public class CreateEquipmentAdminHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateEquipmentAdminHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateEquipmentAdmin.xml");
        }
