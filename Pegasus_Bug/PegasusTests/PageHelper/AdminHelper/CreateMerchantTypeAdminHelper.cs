...
{
    public class CreateMerchantTypeAdminHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateMerchantTypeAdminHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateMerchantTypeAdmin.xml");
        }
