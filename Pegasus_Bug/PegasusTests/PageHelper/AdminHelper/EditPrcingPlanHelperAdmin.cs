...
{
    public class EditPrcingPlanHelperAdmin : DriverHelper
    {
        public LocatorReader locatorReader;

        public EditPrcingPlanHelperAdmin(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("EditPricingPlanAdmin.xml");
        }
