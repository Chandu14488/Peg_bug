...
{
    public class EditEquipmentAdminHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public EditEquipmentAdminHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("EditEquipmentAdmin.xml");
        }
...
// ###########################  XML  ##############
        ...
        public void ClickElementMultiple(string field)
        {
            String locator = locatorReader.ReadLocator(field);
