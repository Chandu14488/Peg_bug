...
{
    public class ResetPasswordOfficeUserAdminHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public ResetPasswordOfficeUserAdminHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("ResetPasswordOfficeAdmin.xml");
        }
