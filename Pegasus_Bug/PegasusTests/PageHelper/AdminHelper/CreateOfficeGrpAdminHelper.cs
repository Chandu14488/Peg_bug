...
{
    public class CreateOfficeGrpAdminHelper : DriverHelper
    {
        public LocatorReader locatorReader;

        public CreateOfficeGrpAdminHelper(IWebDriver idriver)
            : base(idriver)
        {
            locatorReader = new LocatorReader("CreateOfficeGrpAdmin.xml");
        }
