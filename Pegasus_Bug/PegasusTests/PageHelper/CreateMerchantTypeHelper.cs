...
{
    public class CreateMerchantTypeHelper : DriverHelper
    {
...
// ###########################  XML  ##############
        ...
        {
            GetWebDriver().Navigate().GoToUrl("https://www.pegasus-test.com/selenium_corp/masterdata/merchant_types");
        }
        ...
        public void redirectToPayout()
        {
            GetWebDriver()
                .Navigate()
                .GoToUrl("https://www.pegasus-test.com/selenium_corp/selenium_office/merchant_types");
        }
